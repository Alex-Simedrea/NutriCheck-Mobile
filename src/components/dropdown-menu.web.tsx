...
>(({ className, horizontal, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Group
    ref={ref}
    className={cn(
      horizontal && 'flex flex-row justify-between space-x-2',
      className,
    )}
    {...props}
  >
...
>(
  (
    ...
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'relative flex cursor-default select-none flex-row items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        inset && 'pl-8',
